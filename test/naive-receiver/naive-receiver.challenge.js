...
describe('[Challenge] Naive receiver', function () {
    ...
    it('Exploit', async function () {
        const AttackFactory = await ethers.getContractFactory('NaiveAttacker', attacker);
        this.attacker = await AttackFactory.deploy(this.pool.address);
        await this.attacker.connect(attacker).attack(this.receiver.address);
    });
