...
describe('[Challenge] Free Rider', function () {
    ...
    it('Exploit', async function () {
        const AttackerContractFactory = await ethers.getContractFactory('AttackerFreeRider', attacker);
        this.attacker = await AttackerContractFactory.deploy(
        ...
        await this.attacker.connect(attacker).execute();
    });
